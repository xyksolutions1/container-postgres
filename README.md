...
* `branch` will be the repositories branch, typically matching with the version of Postgres eg `17`
...
| `/var/lib/postgresql/`             | Configuration Directory                                 |
...
| `WAL_SEGMENT_SIZE_MB`   | (init) Write ahead log segment size in MB        | `17`       |         |
